...
import com.jhipster.sampleapp.config.KafkaProperties;
...
class JhipsterSampleMonolithicApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleMonolithicApplicationKafkaResource kafkaResource = new JhipsterSampleMonolithicApplicationKafkaResource(
            kafkaProperties
        );
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-monolithic-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-monolithic-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
