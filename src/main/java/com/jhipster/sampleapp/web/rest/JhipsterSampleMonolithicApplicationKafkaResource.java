...
@RestController
@RequestMapping("/api/jhipster-sample-monolithic-application-kafka")
public class JhipsterSampleMonolithicApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleMonolithicApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleMonolithicApplicationKafkaResource(KafkaProperties kafkaProperties) {
